    ...
    <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/60 rounded-[1.5rem] p-5 shadow-xl">
      ...
      <div className="grid grid-cols-3 gap-2">
        {TOP_LEAGUES.map((league) => (
          ...
          >
            <div className="w-6 h-6 mb-1.5 bg-white/5 p-1 rounded-lg flex items-center justify-center transition-colors">
              <img 
            ...
            <span className={`text-[7px] font-black uppercase tracking-tighter text-center leading-tight ${
